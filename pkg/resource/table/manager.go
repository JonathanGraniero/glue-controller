...
// +kubebuilder:rbac:groups=glue.services.k8s.aws,resources=tables,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=glue.services.k8s.aws,resources=tables/status,verbs=get;update;patch

var lateInitializeFieldNames = []string{}

// resourceManager is responsible for providing a consistent way to perform
// CRUD operations in a backend AWS service API for Table custom resources.
...
// EnsureTags is a no-op for Tables since AWS Glue Data Catalog tables do not
// support resource-level tagging via the TagResource API.
...
// FilterSystemTags is a no-op for Tables since AWS Glue Data Catalog tables do not
// support resource-level tagging via the TagResource API.
func (rm *resourceManager) FilterSystemTags(res acktypes.AWSResource, systemTags []string) {
}

// mirrorAWSTags is a no-op for Tables since AWS Glue Data Catalog tables do not
// support resource-level tagging via the TagResource API.
