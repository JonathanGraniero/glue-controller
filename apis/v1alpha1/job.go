...
type JobSpec struct {
	...
	// be defaulted to 7 days. For instance if you have specified a timeout of 20
	...
	//     of memory) with 94GB disk, and provides 1 executor per worker. We recommend
	...
	//     of memory) with 138GB disk, and provides 1 executor per worker. We recommend
	//     this worker type for workloads such as data transforms, joins, and queries,
	//     to offers a scalable and cost effective way to run most jobs.
	//
	//   - For the G.4X worker type, each worker maps to 4 DPU (16 vCPUs, 64 GB
	//     of memory) with 256GB disk, and provides 1 executor per worker. We recommend
	...
	//     of memory) with 512GB disk, and provides 1 executor per worker. We recommend
	//     this worker type for jobs whose workloads contain your most demanding
	//     transforms, aggregations, joins, and queries. This worker type is available
	...
	//     GB of memory) with 84GB disk, and provides 1 executor per worker. We recommend
	//     this worker type for low volume streaming jobs. This worker type is only
	//     available for Glue version 3.0 or later streaming jobs.
	//
